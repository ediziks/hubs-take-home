...
- It took me around 6 hours to complete the task, draw the architecture diagram, create the documentation, fix unclear parts and prepare the Github repository.
